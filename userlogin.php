...
<head>
	...
	<style>
		...
		.background {
            background-image: url('https://images.apollo247.in/pd-cms/cms/2023-05/Donate-blood.jpg');
        ...
        .user_card {
            width: 300px;
            padding: 20px;
            background: rgba(255, 182, 193, 0.8); /* Light baby pink color */
            border-radius: 10px;
		...
		.input-group-text {
            background-color: #ffc0cb; /* Light baby pink color for the icons background */
        }
